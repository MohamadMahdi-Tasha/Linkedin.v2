...
const color = `rgb(${random_color1},${random_color2},${random_color3})`;

// A Function Component That Holds A Profile Picture Element
function Profile_Picture(props) {
    return (
        <div className={'profile-circle p1 w-3rem h-3rem circle dis-flex jc-center ai-center'} style={{backgroundColor: color}}>
